...
<body>
  ...
  <div id="container">
    ...
    <div id="header">
      <h1>διαχείριση θεμάτων διδασκαλίας</h1>
    </div>
    ...
    <div id="main">
       <h2>Σελίδα Θεματοφύλακα</h2>
       <?php echo_msg(); ?>
       
      <br ><ul class='main'>
      <br ><li><a href='\EduSchedule\subjectsManipu\index.php'>ΔΙΑΧΕΙΡΙΣΗ ΘΕΜΑΤΩΝ ΤΩΝ ΜΑΘΗΜΑΤΩΝ Τ.Ε.Ι.</a></li>
