...
<head>
  ...
  <title>ΤΜΗΜΑΤΩΝ-ΜΑΘΗΜΑΤΩΝ ΕΠΙΣΚΟΠΗΣΗ</title>
  ...
  <style type="text/css">
    ...
    #schools, #eventplannedcourses, #eventplannedcourse_scarceresource_participantgroup_combis { 
      float:left;   
      width:140px;        
      padding:10px; 
      margin:5px;   
    ...
    #eventplannedcourses {width: 480px;}    
...
function myAJAXCall(schoolID) {
  ...
  //------- initial. of bussy indicator -----------
   document.getElementById('eventplannedcourses').innerHTML= "<img src= '../spinner.gif' class= 'spinner' />";
  ...
  xmlhttp.onreadystatechange=function() {
    ...
    //αν ο server απάντησε (AJAX readyState 4) και απάντησε επιτυχώς (server http status 200)
      ...
      //την τοποθετούμε μέσα στο δεξιό div
			document.getElementById("eventplannedcourses").innerHTML= xmlhttp.responseText;
		} else 
        document.getElementById("eventplannedcourses").innerHTML= "Μη αποδεκτή απάντηση<br/>στην AJAX κλίση!";
	}
...
<script type="text/javascript">
function myAJAXCallPlus(eventPlannedCourseID) {              
  ...
  xmlhttp2.send("eventPlannedCourseID="+eventPlannedCourseID);   
...
<body>
<div>
<p><h3>&nbsp&nbsp&nbspΕπιθεώρηση Αναθέσεων μέσω των  ΤΜΗΜΑ+=> ΜΑΘΗΜΑ+=> ΑΝΑΘΕΣΗ  εκπαιδευτικού έργου TEI</h3></p>
</div>
<div id="schools">
...
<div id="eventplannedcourses">
  <p class="center">εδώ θα εμφανιστούν<br/>τα διαθέσιμα μαθήματα</p>
</div>   
