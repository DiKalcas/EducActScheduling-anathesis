...
<body>
  ...
  <div id="container">
    ...
    <div id="header">
      <h1>ανάθεση καθηγητών σε διδακτικό έργο</h1>
    </div>
    ...
    <div id="main">
       <h2>Σελίδα Εντολέα ανάθεσης</h2>
       <?php echo_msg(); ?>
       
      <br ><ul class='main'>
      <br ><li><a href='/EduSchedule/evePlannCourse_ScarceResourse_ParticiGroup_COMBIS_manipu/'>ΑΝΑΘΕΣΗ ΕΚΠΑΙΔΕΥΤΙΚΟΥ ΕΡΓΟΥ</a></li> 
    </div>
